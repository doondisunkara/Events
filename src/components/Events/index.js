...
class Events extends Component {
  state = {
    activeRegistrationStatus: 'NO_ACTIVE_EVENT',
  }

  updateActiveStatus = activeRegistrationStatus => {
    this.setState({activeRegistrationStatus})
  }
    ...
    return (
      <div className="events-bg-container">
        ...
        <ActiveEventRegistrationDetails
          activeRegistrationStatus={activeRegistrationStatus}
        />
      </div>
    )
  }
